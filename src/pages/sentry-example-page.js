...
import React, { useState, useEffect } from "react"; // Menambahkan 'React' di sini
    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://institut-teknologi-sepuluh--mi.sentry.io/issues/?project=4509480905211984">Issues Page</a>.
      ...
      <style>{`
        ...
        /* Tidak ada @media (prefers-color-scheme: dark) karena ini adalah CSS bersarang/SCSS yang tidak didukung langsung di style tag biasa. */
        /* Anda mungkin perlu memindahkannya ke file CSS terpisah atau menggunakan paket PostCSS */
